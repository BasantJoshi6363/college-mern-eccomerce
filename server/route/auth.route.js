...
import { authenticatedUser, deleteUser, getAllUsers,  loginUser,  registerUser, updateUser, upgradeToAdmin } from "../controllers/auth.controller.js";
import { admin, protect } from "../middleware/auth.middleware.js";
const auth_router = express.Router();

auth_router.route("/register").post(registerUser);
auth_router.route("/login").post(loginUser);
auth_router.route("/protect").get(protect,authenticatedUser)
