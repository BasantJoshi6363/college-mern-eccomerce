...
import { createProduct, deleteProduct, flashSale, getProductByCategory, getProductById, getProducts, updateProduct } from "../controllers/product.controller.js";
...
product_router.route("/flashsale").get(flashSale)
product_router.route("/categories/:category").get(getProductByCategory)
